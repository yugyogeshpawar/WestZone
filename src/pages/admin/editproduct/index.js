...
import { Button, Typography, Container, Table, TableBody, TableCell, TableHead, TableRow, Modal, Box, TextField, Snackbar } from '@mui/material';
            ...
            <Modal open={modalOpen} onClose={() => setModalOpen(false)}>
                ...
                >
                    ...
                    <form onSubmit={handleEditSubmit}>
                        <TextField label="Name" name="name" value={editingProduct?.name || ''} onChange={handleEditChange} fullWidth required />
                        <TextField label="Description" name="description" value={editingProduct?.description || ''} onChange={handleEditChange} fullWidth required multiline rows={4} />
                        <TextField label="Price" name="price" type="number" value={editingProduct?.price || ''} onChange={handleEditChange} fullWidth required />
